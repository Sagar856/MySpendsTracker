          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              <div>
                ...
                <Input type="number" min={} value={finance.amount} onChange={(e) => setFinance(s => ({ ...s, amount: Number(e.target.value) }))} />
              </div>
        ...
        <TabsContent value="loan" className="mt-4">
          <Card>
            ...
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              <div>
                <label className="text-xs text-muted-foreground">Amount</label>
                <Input type="number" min={} value={loan.amount} onChange={(e) => setLoan(s => ({ ...s, amount: Number(e.target.value) }))} />
              </div>
